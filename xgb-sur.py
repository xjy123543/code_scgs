...
def load_data_with_validation():
    ...
    credit = read_csv_safe("sorted_data_xgb_notime.csv")
    credit2 = read_csv_safe("filtered_data_xgb_notime.csv")
    credit3 = read_csv_safe("排序少样本_data_xgb.csv")
...
if __name__ == "__main__":
    ...
    log_file = os.path.join(log_dir, f"auto_feature_xgb_1_{datetime.now().strftime('%Y%m%d%H%M')}.log")
